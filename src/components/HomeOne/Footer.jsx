                        ...
                        <div className="f-widget widget-1">
                            <div className="logo">
                                <Link href="/">
                                    ...
                                    <h1 className="f-title">SmartTom</h1>
                                </Link>
                            </div>
                            <p className="desc">
                    ...
                    <div className="col-xl-3 col-lg-6">
                        <div className="widget-4">
                            ...
                            <ul className="info-list">
                                <li>
                                    <Link href="tel:+50688391171"
                                    ><i className="fa-solid fa-phone"></i>+506 8839-1171</Link>
                                </li>
                                <li>
                                    <Link href="mailto:infoyour@gmail.com"
                                    ><i className="fa-solid fa-location-dot"></i
                                    >tomazoque@outlook.com</Link>
                                </li>
                                <li>
                                    <Link
                                    ...
                                    ><i className="fa-solid fa-envelope"></i>Heredia, Costa Rica</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="footer-cr">
                <div className="container">
                    <div className="footer-cr-container">
                        <div className="p-left">
                            <p>2022 © All rights reserved by SmartTom</p>
                        </div>
                        <div className="p-right">
